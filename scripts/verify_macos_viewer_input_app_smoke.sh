...
artifact_dir="${1:-${OPENTOONZ_VIEWER_INPUT_APP_SMOKE_DIR:-${TMPDIR:-/tmp}/opentoonz-viewer-input-app-smoke}}"

OPENTOONZ_GRAPHICS_SMOKE_SCENE="${OPENTOONZ_GRAPHICS_SMOKE_SCENE:-doc/sample_data/tga_paint.tnz}" \
OPENTOONZ_GRAPHICS_SMOKE_ACTIONS=internal-viewer-input \
...
echo "verify-macos-viewer-input-app-smoke: ok artifacts=$artifact_dir"
